...
export function Footer() {
  ...
  const footerLinks = {
    tools: [
      { name: t.tools.crop.name, href: '/image/crop' },
      { name: t.tools.removeBg.name, href: '/image/remove-background' },
      { name: t.tools.upscale.name, href: '/image/upscale' },
      { name: t.tools.trimVideo.name, href: '/video/trim' },
    ],
    ecosystem: [
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              {t.home.heroSubtitle.split('.')[0]}. {t.common.tagline}.
            </p>
          </div>
          
          <div>
            <h3 className="font-semibold text-sm mb-3">{t.common.imageTools}</h3>
